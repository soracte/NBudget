...
var gulp = require('gulp'), rjs = require('gulp-requirejs-bundler'), concat = require('gulp-concat'), clean = require('gulp-clean'), filter = require('gulp-filter'),
    ...
    connect = require('gulp-connect'), babelCore = require('babel-core'), babel = require('gulp-babel'), objectAssign = require('object-assign'), jshint = require('gulp-jshint');;
...
var requireJsRuntimeConfig = vm.runInNewContext(fs.readFileSync('src/app/require.config.js') + '; require;'),
    requireJsOptimizerConfig = merge(requireJsRuntimeConfig, {
        ...
        include: [
            ...
            'components/transaction-list/tlist',
            'components/categories-page/categories',
            'components/login-page/login',
            'components/register-page/register',
            'components/external-login/external-login',
            'components/invitations/invitations',
            'components/reports/reports',
            'components/report-details/report-details',
...
gulp.task('css', function () {
    var bowerCss = gulp.src('src/bower_modules/components-bootstrap/css/bootstrap.min.css')
        ...
        pikadayCss = gulp.src('src/bower_modules/pikaday/css/pikaday.css'),
        combinedCss = es.concat(pikadayCss, bowerCss, appCss).pipe(concat('css.css')),
